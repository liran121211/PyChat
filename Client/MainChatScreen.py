...
from PyQt5.QtWidgets import QFrame, QMessageBox, QPushButton, QLabel, QLineEdit
...
from Misc import randomColor, createFont, timeStamp, fetchAvatar, fetchIcon, fetchAppIcon
...
class MainChatScreen(Observable):
    ...
    def setupUi(self, MainChatWindow):
        ...
        x1_loc = ((self.main_window.width() / 2) - 200)
        y1_loc = ((self.main_window.height() / 2) - 200)

        self.settings_panel = QFrame(self.centralwidget)
        self.settings_panel.setGeometry(QRect(x1_loc, y1_loc, 400, 400))
        ...
        # self.settings_panel_avatar.raise_()
    ...
    def retranslateUi(self, MainChatWindow):
        ...
        MainChatWindow.setWindowTitle(
            _translate("PyChat - Communicate with People", "PyChat - Communicate with People"))
    ...
    def initSettingsPanel(self):
        x2_loc = self.settings_panel.width() / 2
        y2_loc = self.settings_panel.height() / 2

        self.settings_panel_avatar = QLabel(self.settings_panel)
        self.settings_panel_avatar.setObjectName(u"settings_panel_avatar")
        self.settings_panel_avatar.setGeometry(x2_loc - 75, 50, 150, 150)
        self.settings_panel_avatar.setPixmap(
            fetchAvatar(self.client.client_db_info["username"], "PIXMAP").scaled(150, 150))
        ...
        self.settings_panel_username.setGeometry(x2_loc - 75, 210, 150, 30)
        self.settings_panel_username.setText('@' + self.client.client_db_info["username"])
